            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="Controlador?menu=Proveedor&accion=Editar&id=${prov.getId()}">Editar</a>
                            <a class="btn btn-danger" href="Controlador?menu=Proveedor&accion=Delete&id=${prov.getId()}">Delete</a>
                        </td>
                    </tr>
                    </c:forEach>
                </tbody>
